...
import "main.go/src/utils"

type MallUser struct {
	UserId        int            `json:"userId" form:"userId" gorm:"column:user_id;primarykey;AUTO_INCREMENT"`
	...
	CreateTime    utils.JSONTime `json:"createTime" form:"createTime" gorm:"column:create_time;comment:注册时间;type:datetime"`
}
